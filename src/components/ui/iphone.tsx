...
export function Iphone({
  ...
  // Unique mask ID per instance: Telemetry renders a mobile + desktop
  // mockup, and duplicate IDs make url(#...) resolve to the hidden one,
  // which leaves the screen covered (blank).
  const maskId = `iphone-screen-${useId().replace(/[^a-zA-Z0-9]/g, "")}`
